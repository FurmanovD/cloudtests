...
// tryLock actually locks the record. Separated to be called from different methods.
// ! No sync.
...
// // redisError wraps out a redis error to represent a RedisLockError
// func (rl *redisLocker) redisError(err error) RedisLockError { //TODO(DF) ???
// 	if err == nil {
// 		return Ok
// 	}

// 	return RedisLockError(fmt.Errorf("redis returned an error: %w", err))
// }
